...
const EditarUsuario = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    // Solo incluir la contraseña si se ha ingresado algo en el campo
    if (data.contrasena) {
      updatedData.contrasena = data.contrasena;
    }
  
    authenticatedApi()
      .put(`/usuario/${id}`, updatedData)
      .then((res) => {
        console.log(res);
  ...
  <input
    type="password" // Cambiamos el tipo a "password" para ocultar el texto
    className="form-control"
    id="contrasena"
