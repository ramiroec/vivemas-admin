...
const EditarPremio = () => {
  ...
  const [data, setData] = useState({
    sucursal: 0,
    categoria_id: 0, // Nueva propiedad para la categoría
    premio: "",
    puntos: 0,
    stock: 0,
    precio: 0,
    foto: "",
    publicid: "", // Asegúrate de que esta propiedad exista
    premio_observacion: "",
    tipo_usuario_id: 0, // Nueva propiedad
  });

  const [sucursalOptions, setSucursalOptions] = useState<Sucursal[]>([]);
  const [categoriaOptions, setCategoriaOptions] = useState<CategoriaPremios[]>([]);
  ...
  useEffect(() => {
    ...
    // Obtener datos del premio existente
    authenticatedApi()
      .get(`/premio/${id}`)
      .then((response) => {
      ...
      .catch((error) => {
        ...
        toast.error("Error al obtener los datos del premio");
      });
  }, [id]);
  ...
  return (
    <div>
      <ContentHeader title="Editar Premio" />
      <section className="content">
        <div className="container-fluid">
          <div className="card card-info card-outline">
            <div className="card-header">
              <h3 className="card-title">Actualizar Información del Premio</h3>
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit} className="row">
                <div className="col-md-6">
                  ...
                  <div className="form-group">
                    <label htmlFor="categoria_id">Categoría de Premio</label>
                    <select
                      className="form-control"
                      id="categoria_id"
                      name="categoria_id"
