...
export const SidebarSearch = () => {
  ...
  const findMenuItems = (menu: any, results: any = []): any[] => {
    ...
    for (const menuItem of menu) {
      ...
      if (lowercaseName.includes(lowercaseSearchText) && menuItem.path) {
        results.push(menuItem);
      }
      if (menuItem.children) {
        // Realiza una búsqueda recursiva en los submenús anidados
        const childResults = findMenuItems(menuItem.children);
